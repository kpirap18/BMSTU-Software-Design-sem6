...
namespace TrasferSystemTests
{
    ...
    public class TestTransferSystem
    {
        ...
        {
            IUserInfoRepository rep = new UserInfoRepository(new transfersystemContext(Connection.GetConnection((int)Permissions.Moder, _config)));
            ...
            Userinfo checkUser2 = rep.FindUserByID(102);
            ...
            Assert.IsNotNull(rep.FindUserByID(checkUser2.Id), "user2 was not deleted");
        ...
        {
            IHotelRepository rep = new HotelRepository(new transfersystemContext(Connection.GetConnection((int)Permissions.Moder, _config)));
        ...
        {
            IVisitorRepository rep = new VisitorRepository(new transfersystemContext(Connection.GetConnection((int)Permissions.Moder, _config)));
        ...
        {
            IStatisticsRepository rep = new StatisticsRepository(new transfersystemContext(Connection.GetConnection((int)Permissions.Moder, _config)));
        ...
        {
            IAvailableDealsRepository rep = new AvailableDealsRepository(new transfersystemContext(Connection.GetConnection((int)Permissions.Moder, _config)));
            ...
            deals = rep.GetIncomingDeals(new Management(mid: 3));
        ...
        {
            IInterestVisitorsRepository rep = new InterestVisitorsRepository(new transfersystemContext(Connection.GetConnection((int)Permissions.Moder, _config)));
