...
namespace ComponentAccessToDB
{
    public class VisitorRepository : IVisitorRepository, IDisposable
    {
        ...
        public void Add(Visitor element)
        {
            try
            {
                //element = new Visitor(vid: db.Visitors.Count() + 1,
                  //                    hid: element.HotelID,
                    //                  s: element.Statistics,
                      //                name: element.Name,
                        //              age: element.Age,
        ...
        {
            IQueryable<Visitor> visitors = db.Visitors.OrderBy(z => z.VisitorID).Where(z => z.VisitorID < limit);
