...
namespace ComponentAccessToDB
{
    public partial class transfersystemContext : DbContext
    {
        ...
        public virtual DbSet<InterestVisitor> InterestVisitors { get; set; }
        public virtual DbSet<Management> Managements { get; set; }
        public virtual DbSet<Visitor> Visitors { get; set; }
        public virtual DbSet<Statistic> Statistics { get; set; }
        public virtual DbSet<Hotel> Hotels { get; set; }
        public virtual DbSet<Userinfo> Userinfos { get; set; }
        public IQueryable<VisitorHotelStat> getvisitors() => FromExpression(() => getvisitors());
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<InterestVisitor>(entity =>
            {
                entity.ToTable("InterestVisitors");
